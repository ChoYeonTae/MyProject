	...
	<div class="container">
		...
		<div class="row">
								...
								<table class="table">
									<tr>
										...
										<td class="text-right">
											<c:if test="${sessionScope.id==rvo.id }">
												...
												<a href="reply_delete.jsp?no=${rvo.no }&bno=${vo.no}&page=${curpage}"
									...
									<tr>
										<td colspan="2" valign="top">
											<pre style="background-color: gray;opacity: o.5;color: #fff">${rvo.msg }</pre>
										</td>
									</tr>
			...
			<table class="table">
				<tr>
					<td>
						<form method="post" action="reply_inset.jsp">
